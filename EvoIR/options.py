...
parser.add_argument('--resume', type=str, default=False, help='load pretrained model.')
parser.add_argument('--resume_path', type=str, default="checkpoints/", help='load pretrained model.')
...
# parser.add_argument('--de_type', nargs='+', default=['dehaze'],
#                     help='which type of degradations is training and testing for.')
...
#
parser.add_argument('--denoise_dir', type=str, default='/l/users/salman.khan/jiaqima/AIO/data/train/Denoise/',
                    help='where clean images of denoising saves.')

parser.add_argument('--gopro_dir', type=str, default='/l/users/salman.khan/jiaqima/AIO/data/train/Deblur/',
                    help='where clean images of denoising saves.')
parser.add_argument('--enhance_dir', type=str, default='/l/users/salman.khan/jiaqima/AIO/data/train/Low-light/',
                    help='where clean images of denoising saves.')

parser.add_argument('--derain_dir', type=str, default='/l/users/salman.khan/jiaqima/AIO/data/train/Derain/',
                    help='where training images of deraining saves.')
parser.add_argument('--dehaze_dir', type=str, default='/l/users/salman.khan/jiaqima/AIO/data/train/Dehaze/',
...
parser.add_argument("--ckpt_dir",type=str,default="EvoIR",help = "Name of the Directory where the checkpoint is to be saved")
